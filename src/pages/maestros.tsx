              ...
              <div className="hero-content lg:items-start flex-col lg:flex-row gap-8">
                ...
                <div>
                  ...
                  <p className="py-6">
                    ...
                    experiencia. Practiqué estilos y métodos muy variados e hice
                    dos formaciones en hatha yoga y yoga restaurativo, pero fue
                    la profundidad del yoga Iyengar la que me cautivó.
                    <br />
                    <br /> Continuo estudiando, preparándome y practicando bajo
                    las enseñanzas de este método. He estudiado directamente con
                    la familia Iyengar en Pune, India y he tomado clases y
                    talleres intensivos con profesores senior como Chantal Gómez
                    Jauffred (México), David Meloni (Italia), Gloria Goldberg
                    (EUA), Christian Pisano (Francia), Lois Steinberg (EUA),
                    Jawahar Banghera (India), Peter Scott (Australia), Usha Devi
                    (Suiza), Alan Brown (Inglaterra), entre otros además estudié
                    filosofía del yoga y sánscrito con el Dr. Roberto García.{" "}
                    <br />
                    <br />
                    Para mí, el yoga es una vía para conectar con mi interior,
                    una herramienta de transformación no solo a nivel físico
                    sino a niveles más profundos. Trato de que mi enseñanza sea
                    entusiasta, busco combinar el dinamismo y la frescura con la
                    precisión y atención características del método Iyengar.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="hero-content lg:items-start flex-col lg:flex-row gap-8">
                ...
                <div>
                  ...
                  <p className="py-6">
                    ...
                    clases en la Universidad Iberoamericana desde 2019 y he sido
                    instructora en diversos centros deportivos y culturales. Soy
                    egresada como cirujana dentista por la UNAM.
                  </p>
                </div>
